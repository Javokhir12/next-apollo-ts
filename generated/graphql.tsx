...
/**
 * __useFilterCharactersByNameQuery__
 *
 * To run a query within a React component, call `useFilterCharactersByNameQuery` and pass it any options that fit your needs.
 * When your component renders, `useFilterCharactersByNameQuery` returns an object from Apollo Client that contains loading, error, and data properties
 ...
 * });
 */
export function useFilterCharactersByNameQuery(
  ...
  return Apollo.useQuery<
    FilterCharactersByNameQuery,
    FilterCharactersByNameQueryVariables
  >(FilterCharactersByNameDocument, options);
}
export function useFilterCharactersByNameLazyQuery(
...
export type FilterCharactersByNameQueryHookResult = ReturnType<
  typeof useFilterCharactersByNameQuery
>;
export type FilterCharactersByNameLazyQueryHookResult = ReturnType<
  typeof useFilterCharactersByNameLazyQuery
>;
